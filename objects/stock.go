...
const (
	...
	StockSymbolForexCurrencyPairs StockSymbolExchange = "available-forex-currency-pairs"
	StockSymbolCrypto             StockSymbolExchange = "available-crypto"
	StockSymbolCryptoCurrencies   StockSymbolExchange = "available-cryptocurrencies"
